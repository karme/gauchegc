 ...
 *
 * 4 Jul 01    Shigenobu Kimura <skimu@mac.com>
 *      - moved fft functions into ``fftn.inc'' to avoid recursive
 *        #include __FILE__, some cpp would complain/confuse about it.
 * ----------------------------------------------------------------------*/
/*}}}*/
#include <stdio.h>
#include <stdlib.h>
...
/* include source file for double and single presition */
/*{{{ defines for including double precision */
#ifdef FFT_NODOUBLE
# ifndef FFT_FLOAT
#  define FFT_FLOAT
# endif
...
# include "fftn.inc"			/* include fft functions */
#endif
/*}}}*/

/*{{{ defines for including float precision */
#ifdef FFT_FLOAT
# undef REAL
# undef FFTN
# undef FFTNS
